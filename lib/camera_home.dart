...
class _CameraExampleHomeState extends State<CameraHome>
  ...
  Widget _captureControlRowWidget() {
    ...
    return Row(
      ...
      mainAxisSize: MainAxisSize.max,
      children: <Widget>[
        /// This is the camera capture code.
        IconButton(
  ...
  void onPauseButtonPressed() {
    pauseVideoRecording().then((_) {
      ...
      ///If //? 1&2 ? read aloud : ignore.
      ///1: voice output has been enabled.
      ///2. gesture has been enabled.
      ///
      ///If gestures will not be used then feature is inaccessible.
    });
  }
